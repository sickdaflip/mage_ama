...
class Amasty_Promo_Model_Sales_Quote_Item extends Mage_Sales_Model_Quote_Item
{
    ...
    public function representProduct($product)
    {
        if (parent::representProduct($product)) {
            ...
            $productBuyRequest = new Varien_Object($option ? Mage::helper('ampromo')->unserialize($option->getValue()) : null);
    ...
    public function getBuyRequest()
    {
        ...
        $buyRequest = new Varien_Object($option ? Mage::helper('ampromo')->unserialize($option->getValue()) : null);
