...
class Amasty_Promo_Block_Adminhtml_System_Config_Fieldset_Info
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    protected $_contentHtml = '';

    protected $_moduleCode = 'Amasty_Promo';

    protected $_userGuideLink = 'https://amasty.com/docs/doku.php?id=magento_1:auto_add_promo_items';
    ...
    public function getAdditionalModuleContent()
    {
        ...
        if (!@class_exists('Amasty_Base_Helper_String')) {
            $messages['error'] = \Amasty_Promo_Helper_Data::ERROR_MESSAGE;
        }
